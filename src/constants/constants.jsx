...
export const GET_BALANCES_NFT = 'GET_BALANCES_NFT'
export const BALANCES_NFT_RETURNED = 'BALANCES_NFT_RETURNED'
...
export const TRIGGER_SWAP = 'TRIGGER_SWAP'
export const TRIGGER_SWAP_RETURNED = 'SWAP_RETURNED'
